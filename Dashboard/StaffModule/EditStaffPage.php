...
<div class="container">
    <div class="text-center mb-4">
         <h3>Edit User</h3>
            <p class="text-muted">Complete the form below to edit a user</p>
    </div>
    ...
    if (isset($_GET["id"])) {
        $id = $_GET["id"];
        $sql = "SELECT * FROM userlogin WHERE id = '$id' LIMIT 1";
    ...
    <div class="container d-flex justify-content-center">
        <form action="editStaff.php?id=<?php echo $_GET['id']; ?>" style="width:50vw; min-width:300px;" method="POST">
