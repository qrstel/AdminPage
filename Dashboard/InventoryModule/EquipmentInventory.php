...
<head>
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    ...
    <button type="button" id="insertItembtn" class="btn btn-dark mb-4 mt-3">Add New Equipment</button>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
            <a href="EquipmentEditPage.php?id=<?php echo $row["id"] ?>" class="btn btn-outline-success me-2"
...
<div class="container" id="itemForm" style="display:none;">
    <div class="text-center mb-4">
         <h3>Add New Equipment</h3>
            <p class="text-muted">Complete the form below to add an equipment</p>
    </div>
          
    <div class="container d-flex justify-content-center">
        <form action="equipment_add.php" method="post" style="width:50vw; min-width:300px;">

             <div class="row mb-3">
                <div class="col">
                    <label class="form-label">Item Name:</label>
                    <input type="text" class="form-control" name="itemName" placeholder="Item" required>
                </div>
